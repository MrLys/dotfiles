...
_G.packer_plugins = {
  ...
  ["chatgpt.nvim"] = {
    loaded = true,
    path = "/home/thomas/.local/share/nvim/site/pack/packer/start/chatgpt.nvim",
  ...
  ["debugprint.nvim"] = {
    loaded = true,
    path = "/home/thomas/.local/share/nvim/site/pack/packer/start/debugprint.nvim",
  ...
  ["telescope-undo.nvim"] = {
    loaded = true,
    path = "/home/thomas/.local/share/nvim/site/pack/packer/start/telescope-undo.nvim",
